...
const T = {
  ko: {
    ...
    s2h: "버틴다", s2p: "시간이 흐르며 캡슐이 자랍니다 — 씨앗에서 만개까지. 중간에 깬 사람들의 페널티가 버틴 당신에게 쌓입니다.",
  ...
  en: {
    ...
    s2h: "Hold", s2p: "The capsule grows over time — from seed to full bloom. Penalties from quitters accrue to you for holding.",
